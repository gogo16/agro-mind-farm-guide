...
const MapView = () => {
  ...
  const crops = ['Grâu', 'Porumb', 'Floarea-soarelui', 'Orz', 'Ovăz', 'Rapiță', 'Soia', 'Cartofi', 'Sfeclă de zahăr'];
  const colors = [{
    name: 'Verde',
    value: '#22c55e'
  }, {
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input id="name" value={fieldForm.name} onChange={e => setFieldForm(prev => ({
                  ...prev,
                  name: e.target.value
                ...
                <div>
                  ...
                  <Select value={fieldForm.crop} onValueChange={value => setFieldForm(prev => ({
                  ...prev,
                  crop: value
                }))}>
                    <SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="size" type="number" step="0.1" value={fieldForm.size} onChange={e => setFieldForm(prev => ({
                    ...prev,
                    size: e.target.value
                  }))} placeholder="Ex: 2.5" />
                  </div>
                  <div>
                    ...
                    <Input id="parcel_code" value={fieldForm.parcel_code} onChange={e => setFieldForm(prev => ({
                    ...prev,
                ...
                <div>
                  ...
                  <Input id="location" value={fieldForm.location} onChange={e => setFieldForm(prev => ({
                  ...prev,
                ...
                <div>
                  ...
                  <Select value={fieldForm.color} onValueChange={value => setFieldForm(prev => ({
                  ...prev,
                  color: value
                }))}>
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      {colors.map(color => <SelectItem key={color.value} value={color.value}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="planting_date" type="date" value={fieldForm.planting_date} onChange={e => setFieldForm(prev => ({
                    ...prev,
                  ...
                  <div>
                    ...
                    <Input id="harvest_date" type="date" value={fieldForm.harvest_date} onChange={e => setFieldForm(prev => ({
                    ...prev,
                ...
                {selectedCoordinates && <div className="p-3 bg-green-50 rounded-lg">
          ...
          <div className="lg:col-span-3">
            <Card className="bg-white border-green-200">
              <CardContent className="p-0">
                <InteractiveMap mapType="roadmap" onFieldSelect={field => {
                toast({
                  title: field.name,
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white border-green-200">
              ...
              <CardContent className="space-y-3">
                {Object.entries(fieldsByCrop).map(([crop, cropFields]) => <div key={crop} className="flex justify-between items-center">
                ...
                {Object.keys(fieldsByCrop).length === 0 && <p className="text-gray-500 text-center py-4">Nu există parcele adăugate</p>}
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-green-200">
              ...
              <CardContent className="space-y-2">
                {fields.map(field => <div key={field.id} className="flex items-center space-x-2">
                    <div className="w-4 h-4 rounded-full border" style={{
