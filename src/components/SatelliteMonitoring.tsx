...
const SatelliteMonitoring = () => {
  ...
  // Mock satellite data since table was deleted
  const [mockSatelliteData] = useState([
    {
      id: '1',
      field_id: '1',
  ...
  const selectedParcelData = selectedParcel ? mockSatelliteData.find(d => d.field_id === selectedParcel) : null;
