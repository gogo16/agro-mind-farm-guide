...
const SoilSection = ({ fieldId }: SoilSectionProps) => {
  ...
  const renderEditableValue = (field: string, value: number, unit: string, label: string) => {
    ...
    return (
      <div className="cursor-pointer hover:bg-gray-100 p-1 rounded" onClick={() => setEditingField(field)}>
  ...
  const basicRecommendations = getBasicRecommendations();
    ...
    <div className="space-y-6">
      <Card className="bg-white border-green-200">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="mt-6">
            <h4 className="font-semibold text-gray-900 mb-3">Recomandări de bază</h4>
