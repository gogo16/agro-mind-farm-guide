...
const InventorySystem = () => {
  ...
  const cropItems = inventory.filter(item => item.category === 'crops');
  const materialItems = inventory.filter(item => item.category === 'materials');
  const fuelItems = inventory.filter(item => item.category === 'fuel');
  ...
  const handleAddItem = () => {
    ...
    const itemToAdd = {
      ...
      unit: newItem.type === 'fuel' ? 'L' : newItem.type === 'equipment' ? 'buc' : 'kg',
      ...
      <div key={item.id} className="border border-gray-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
          <div>
            ...
            {item.quantity && <p><strong>Cantitate:</strong> {item.quantity} {item.unit}</p>}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input 
                      placeholder={newItem.type === 'fuel' ? "ex: 3500" : "ex: 500"} 
        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="chemicals" className="space-y-4">
              {renderInventoryItems(chemicalItems, 'chemicals')}
            </TabsContent>

            <TabsContent value="crops" className="space-y-4">
              {renderInventoryItems(cropItems, 'crops')}
            </TabsContent>

            <TabsContent value="materials" className="space-y-4">
              {renderInventoryItems(materialItems, 'materials')}
            </TabsContent>
