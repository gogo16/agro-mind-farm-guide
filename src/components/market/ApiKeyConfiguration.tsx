...
const ApiKeyConfiguration = ({
  ...
  return <Card className="bg-white border-green-200">
      
      
      {showApiKeyInput && <CardContent className="border-t pt-4">
          <div className="space-y-4">
            <div>
              <Label htmlFor="apiKey">Cheia API pentru Bursa de Cereale</Label>
              <Input id="apiKey" type="password" value={apiKey} onChange={e => setApiKey(e.target.value)} placeholder="Introdu cheia API..." />
